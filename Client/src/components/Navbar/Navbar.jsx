                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form className="d-flex" role="search">
                        <div className="input-group">
                            <input type="search" className="form-control w-[300px] " placeholder="Search" aria-label="Search" style={{ width: "500px" }} />
                    ...
                    <ul className="navbar-nav mx-1 mx-lg-5 mb-2 mb-lg-0 gap-3">
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu">
                                ...
                                <li>
                                    <Link className="dropdown-item fs-6 font-monospace fw-semibold text-uppercase" to="/wishlist">
